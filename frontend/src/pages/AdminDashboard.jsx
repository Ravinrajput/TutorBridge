...
export default function AdminDashboard() {
  ...
  const assignTeacher = async (requestId) => {
    const name = teacherNames[requestId];
    ...
    try {
      await axios.put(
        `${API}/api/admin/assign-teacher/${requestId}`,
        null,
        {
          params: {
            teacherName: name,
      ...
      setTeacherNames(prev => ({ ...prev, [requestId]: "" }));
